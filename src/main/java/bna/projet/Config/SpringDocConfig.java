...
public class SpringDocConfig {
    ...
    public Info infoaPl() {
        ...
        return new  Info().title("SpringDoc - Kaddem  Spring boot 4Twin6 ").description("Aziz Ben Ismail - Eya ben Amor - Amen jouini - Yassmine mouadeb- aziz ben hmida - Amdouni Mounaaaaa").contact(contactAPI());
